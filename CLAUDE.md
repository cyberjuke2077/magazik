...
3. `CLAUDE.md` (этот файл) - структура, роутинг, правила
...
.claude/
├── settings.json     # запреты инструментов
└── skills/           # скиллы on-demand
```
...
| Обновление второго мозга | `.claude/skills/brain-update.md` |
...
5. Что изменить в CLAUDE.md (если были грабли)
