...
> История подготовки. Актуальное состояние: [итоги выпуска](release-closeout-2026-09-20.md).
> PR #26 слит, production READY на `ae1f732`, backup/миграции выполнены.
> Прежние ожидаемые разрешения ниже закрыты подтверждением владельца;
> новое уточнение касается штатной обработки очереди.
