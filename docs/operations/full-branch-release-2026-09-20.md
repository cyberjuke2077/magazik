...
Ветка: `codex/adversarial-review-20260917`. Принятый код с R2: `37cba51`;
первая стабилизация release-проверок: `d9bf95b5a973c50feb0d84dd1227bb46110961a4`.
Текущую вершину ветки и финальные статусы проверять в PR #26.
...
на desktop и mobile: 12 passed. Полный CI нового кандидата обязателен,
первый неуспешный запуск не считать пройденным.
