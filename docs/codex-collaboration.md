...
| Production | `https://electromagaz-production.vercel.app` | deploy только из `main`; deployment `dpl_AXPeVvrC9c9seZzoJBgYQjGTPnFw` после PR #15 принят smoke-test 2026-08-20 |
