...
const steps = [
  ...
  { icon: Calculator, title: 'Проверка и расчёт', desc: 'Проверим наличие и сформируем КП с ценами и сроками.' },
  { icon: FileSignature, title: 'Условия и оплата', desc: 'Согласуем способ оплаты и зафиксируем условия в документах.' },
  { icon: Truck, title: 'Поставка и документы', desc: 'Организуем поставку и передадим согласованный комплект документов.' },
]
