...
const faqs = [
  {
    ...
    a: 'Да, это основной формат работы. Условия оплаты, договора и комплект документов фиксируем в коммерческом предложении.',
  },
  {
  ...
  },
  {
    ...
    a: 'Можно направить менеджеру технический запрос. Возможность подбора и параметры замены подтвердим отдельно.',
  },
  {
  ...
  },
  {
    ...
    a: 'Способ, стоимость, адрес и срок поставки согласуем для конкретной заявки и укажем в коммерческом предложении.',
  },
]
