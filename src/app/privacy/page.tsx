...
const sections = [
  {
    ...
    content: [
      'Настоящая политика определяет порядок обработки и защиты ООО «Электромагаз» (далее — Оператор) персональных данных пользователей сайта electromagaz.ru (далее — Сайт).',
  ...
  },
  {
    ...
    content: [
      ...
      'При регистрации в личном кабинете: email, пароль (хранится в зашифрованном виде), ФИО, телефон.',
  ...
  },
  {
    ...
    content: [
      ...
      'Отозвать согласие на обработку, направив запрос на info@electromagaz.ru.',
  ...
  },
  {
    ...
    content: [
      ...
      'Email: privacy@electromagaz.ru',
      'Телефон: 8 (800) 555-35-35',
      'Почтовый адрес: 105005, г. Москва, ул. Электронная, д. 12, оф. 405',
    ],
  },
]
