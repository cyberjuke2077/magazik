...
const sections = [
  ...
  },
  {
    ...
    content: [
      'Корзина и ссылки на последние заявки хранятся в localStorage браузера. Историю ссылок можно удалить на странице «Ваши заявки». Для защиты от повторной отправки в sessionStorage сохраняются случайный ключ и хеш заявки без контактных данных. Cookie используются для сессии администратора.',
