...
const faqCategories = [
  {
    ...
    questions: [
      ...
      { q: 'Какие способы оплаты доступны?', a: 'Способ и срок оплаты указываются в коммерческом предложении, счёте или договоре.' },
      { q: 'Можно ли изменить или отменить заявку?', a: 'Свяжитесь с менеджером. Возможность изменения зависит от статуса поставки и согласованных условий.' },
    ],
  },
  {
    title: 'Доставка',
    ...
    questions: [
      ...
      { q: 'Как узнать срок поставки?', a: 'Срок зависит от выбранных позиций и подтверждается менеджером в коммерческом предложении.' },
      { q: 'Можно ли забрать заказ самовывозом?', a: 'Возможность и адрес самовывоза необходимо согласовать с менеджером до оплаты.' },
    ],
  },
  {
    ...
    icon: RefreshCw,
    questions: [
      { q: 'Как сообщить о проблеме с товаром?', a: 'Направьте номер заказа, описание проблемы и подтверждающие материалы на рабочий email.' },
      { q: 'Как рассматривается возврат?', a: 'Основание, срок и способ возврата определяются согласованными B2B-условиями и применимым законодательством.' },
      { q: 'Можно ли заменить товар?', a: 'Возможность замены рассматривается после проверки обращения и условий конкретной поставки.' },
    ],
  },
  {
    ...
    icon: Package,
    questions: [
      { q: 'Как узнать наличие товара?', a: 'Каталог помогает сформировать заявку. Актуальное наличие подтверждается в коммерческом предложении.' },
      { q: 'Можно ли запросить товар вне каталога?', a: 'Укажите производителя, MPN и количество в заявке - менеджер проверит возможность поставки.' },
      { q: 'Какие документы доступны на товар?', a: 'Доступные документы и гарантийные условия подтверждаются для конкретной позиции в коммерческом предложении.' },
    ],
  },
]
