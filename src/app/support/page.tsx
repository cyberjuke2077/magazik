...
export const metadata: Metadata = {
  title: 'Техподдержка',
  description:
    'Форма технического запроса Electromagaz по аналогам, документации и поиску компонентов.',
}
...
const services = [
  {
    ...
    desc: 'Направьте исходный MPN и обязательные параметры - возможность подбора уточнит менеджер.',
  },
  {
    icon: LifeBuoy,
    title: 'Вопрос по документации',
    desc: 'Можно запросить доступный datasheet или уточнить документацию для конкретной позиции.',
  },
  {
    icon: MessageCircle,
    title: 'Запрос редкой позиции',
    desc: 'Пришлите точный MPN и количество - возможность поставки проверяется индивидуально.',
  },
]
...
const faq = [
  {
    ...
    a: 'Срок ответа зависит от полноты данных и сложности проверки. Менеджер свяжется с вами после обработки запроса.',
  },
  {
    q: 'Можно ли получить образец компонента для тестирования?',
    a: 'Возможность, минимальная партия, стоимость и срок образца проверяются для конкретного компонента.',
  },
  {
    q: 'Предоставляете ли вы datasheets на нестандартные компоненты?',
    a: 'Доступный datasheet показывается в карточке товара. Дополнительную документацию можно запросить у менеджера.',
  },
  {
    q: 'Помогаете ли с подбором по техническому заданию (ТЗ)?',
    a: 'Техническое задание можно приложить к запросу. Возможность и условия подбора подтверждаются после его рассмотрения.',
  },
  {
    q: 'Можно ли получить сертификат соответствия?',
    a: 'Наличие сертификата, декларации или паспорта качества проверяется отдельно для конкретной позиции до согласования поставки.',
  },
]
      ...
      <main className="flex-1">
        ...
        <div className="mx-auto max-w-[1380px] px-4 py-7 lg:px-0">
          ...
          <p className="text-sm text-ink-3 mb-8 max-w-3xl">
            Направьте вопрос по MPN, аналогу или документации. Возможность и формат
            технической помощи менеджер подтвердит после рассмотрения запроса.
          </p>
