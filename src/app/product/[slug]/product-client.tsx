...
type Tab = 'description' | 'specs' | 'delivery' | 'docs'
                ...
                <div>
                  {product.datasheets.length > 0 ? (
                    <div className="space-y-3">
                      {product.datasheets.map((datasheet) => (
                        <a
                          ...
                          className="flex items-center justify-between p-4 bg-gray-50 rounded border border-gray-100 hover:border-[#0066cc] hover:bg-[#e8f4ff] transition-all group"
                        >
                          <div className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 bg-white rounded border border-gray-200 group-hover:border-[#0066cc] transition-colors">
                              <FileText size={18} className="text-gray-400 group-hover:text-[#0066cc] transition-colors" />
                            </div>
                            <div>
                              <div className="text-sm font-semibold text-gray-900 group-hover:text-[#0066cc] transition-colors">
                                {datasheet.title}
                              </div>
                              <div className="text-xs text-gray-400">PDF документ</div>
                            </div>
                          </div>
                          <Download size={16} className="text-gray-400 group-hover:text-[#0066cc] transition-colors" />
                        </a>
                      ))}
                    </div>
                  ) : (
                    <div className="text-center py-8">
                      ...
                      <p className="text-sm text-gray-500">Документация для этого товара отсутствует</p>
                    </div>
                  )}
                </div>
              )}
