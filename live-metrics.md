...
## Snapshot ревью 2026-09-17

Read-only SQL в подтверждённом `37Lunar's Org / 37Lunar's Project`, ref
`dbumwpnbtvixfusxnggn`: 51 товар, 4 с ценой больше нуля, 0 с оптовой ценой,
0 с признаком наличия, 0 с положительным складским остатком, 0 с minOrder > 1.
Агрегаты заявок и персональные данные этим ревью не извлекались.

Публичный BrowserAct smoke подтвердил поиск STM32F103C8T6, добавление в корзину
и форму запроса КП. Найдены ошибки поиска и оформления; подробности в
[адверсариальном ревью](docs/operations/adversarial-review-2026-09-17.md).
Это не подтверждение готовности к запуску и не проверка SHA текущего deployment.

## Исторический публичный snapshot до ревью
